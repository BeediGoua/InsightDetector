# src/detection/level1_heuristic_enhanced.py
"""
...
@dataclass
class EnhancedHeuristicResult:
    """Résultat enrichi de l'analyse heuristique niveau 1."""
    is_suspect: bool
...
class EnhancedHeuristicAnalyzer:
    """
    ...
    def analyze_summary(self, summary: str, metadata: Optional[Dict] = None) -> EnhancedHeuristicResult:
        """
        ...
        Returns:
            EnhancedHeuristicResult avec diagnostic détaillé
        """
        ...
        return EnhancedHeuristicResult(
    ...
    def analyze_batch(self, summaries: List[Dict], 
                     enable_progress: bool = True) -> Tuple[List[Dict], List[EnhancedHeuristicResult]]:
        """
    ...
    def get_analysis_statistics(self, results: List[EnhancedHeuristicResult]) -> Dict[str, Any]:
